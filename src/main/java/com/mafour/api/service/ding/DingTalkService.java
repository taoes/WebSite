...
public class DingTalkService {
  ...
  public void sendPushMsg() {
    ...
    com.mafour.api.service.ding.NetUtils.sendDingMsg(token, content);
  }
  ...
  public void sendCommentMsf(String name, String content, String book, String slug) {
    ...
    com.mafour.api.service.ding.NetUtils.sendDingMsg(token, msgContent);
  }
  ...
  public void sendStatMsf(String bookName, String slug, Integer value) {
    ...
    BtnLink btnLink =
        new BtnLink(
            "查看文章", "https://www.zhoutao123.com/page/book/" + bookName + "/category/" + slug);
    cardContent.setBtns(Collections.singleton(btnLink));
